...
<div class="files">
<input value="<?php $_SESSION['product_img1'];?>" type="file" name="img1" accept="image/jpg, image/jpeg, image/png, image/webp"><a><?php echo $_SESSION['product_img1'];?></a>
<input type="file" name="img2" accept="image/jpg, image/jpeg, image/png, image/webp"><a><?php echo $_SESSION['product_img2'];?></a>
<input type="file" name="img3" accept="image/jpg, image/jpeg, image/png, image/webp"><a><?php echo $_SESSION['product_img3'];?></a>
</div>
...
<h1>Description</h1><textarea placeholder="Description" name="description"><?php echo $_SESSION['description']; ?></textarea>



<h3>Category:<select name="categories">
<option value="<?php echo $_SESSION['categories']; ?>"><?php echo $_SESSION['categories']; ?></option>
...
<h3>Amount:<input type="number" name="amount" value="<?php echo $_SESSION['amount']; ?>"></h3>

<h3>Price:<input type="number" placeholder="Price" name="price" value="<?php echo $_SESSION['price']; ?>"></h3>
</div>
...
if(isset($_POST["update"])){
   ...
   $sql = "UPDATE products
SET product_name = '$product_name', price = '$price', description = '$description', product_img1 = '$img1', product_img2 = '$img2', product_img3  = '$img3', categories = '$categories', amount = '$amount'
WHERE product_id = $update_id
;";
...
$_SESSION['product_img1'] = $img1;
$_SESSION['product_img2'] = $img2;
$_SESSION['product_img3'] = $img3;
