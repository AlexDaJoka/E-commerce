...
WHERE user_taker_id = $user_id OR user_sender_id = $user_id
;";
...
$_SESSION['user_sender_id'] = $row['user_sender_id'];
$_SESSION['user_taker_id'] = $row['user_taker_id'];
...
$user_id = $_SESSION['user_id'];
$user_sender = $_GET["send_to"];

$sql = "SELECT * FROM privat_messages
WHERE user_taker_id = $user_id AND user_sender_id = $user_sender OR user_taker_id = $user_sender AND user_sender_id = $user_id
;";
