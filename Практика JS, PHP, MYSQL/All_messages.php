...
<p>user_sender_id:<?php echo $value['user_sender_id']; ?></p>
<a href="Message_answer.php?send_to=<?= $value['user_sender_id']; ?>"><?php echo $value['messages']?></a>
<p>message_id:<?php echo $value['message_id']; ?></p>
